...
export const guardBodyValition = Joi.object({
  ...
  nombre: Joi.string()
    ...
    .messages({
      ...
      "string.pattern.base":
        "El campo nombre no puede contener números ni símbolos.",
  ...
  apellido: Joi.string()
    ...
    .messages({
      ...
      "string.pattern.base":
        "El campo apellido no puede contener números ni símbolos.",
  ...
  telefono: Joi.string()
    ...
    .messages({
      ...
      "string.pattern.base":
        "El teléfono debe tener el formato +56 9 XXXX XXXX y solo contener números.",

                    ...
                    <div className="divide-y divide-slate-50">
                        {activityList.map((mov) => (
                            <div key={mov.id} className="p-4 hover:bg-slate-50 transition-colors flex items-center gap-3">
                                ...
                                <div className={`p-2 rounded-full ${mov.tipo === 'Ingreso' ? 'bg-emerald-50 text-emerald-600' : 'bg-rose-50 text-rose-600'
                                    }`}>
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        <span className={`text-[10px] px-1.5 py-0.5 rounded border ${mov.tipo === 'Ingreso'

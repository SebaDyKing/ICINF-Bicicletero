...
export default function BicycleCard({ data, isActive, onClick, onEdit }) {
  ...
  return (
    <div
      ...
      className={`relative p-6 rounded-2xl transition-all duration-300 group cursor-pointer ${isActive
        ? 'bg-gradient-to-br from-[#003366] via-[#004080] to-[#0066cc] border-[#003366] shadow-2xl shadow-blue-500/30 transform scale-[1.02]'
        : 'bg-white text-gray-800 border-gray-200 hover:shadow-[0_20px_40px_-5px_rgba(0,51,102,0.4)] hover:-translate-y-2'
        }`}
    >
      ...
      <div className="absolute bottom-4 right-4 flex gap-2">
        <button
          ...
          className={`p-2 rounded-lg transition-all backdrop-blur-sm group-hover:scale-110 hover:scale-125 wiggle-on-hover active:scale-95 ${isActive
            ? 'bg-white/10 text-white hover:bg-white/20 border border-white/10'
            : 'bg-gray-50 text-gray-400 hover:bg-gray-100 group-hover:text-[#003366]'
            }`}>
          <Edit2 size={18} />
        </button>
        ...
        <button
          ...
          className={`p-2 rounded-lg transition-all backdrop-blur-sm group-hover:scale-110 hover:scale-125 shake-on-hover active:scale-95 ${isActive
            ? 'bg-white/10 text-white hover:bg-white/20 border border-white/10'
            : 'bg-gray-50 text-gray-400 hover:bg-red-50 group-hover:text-red-500'
            }`}>
          <Trash2 size={18} />
        </button>
      </div>
